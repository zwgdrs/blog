...
class AboutComponent extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <div styleName="aboutContent" ref={el=>{this.about=el}} dangerouslySetInnerHTML={{__html:data}}></div>
                <div styleName="aboutBtn" onClick={()=>{this.aboutSubmit()}} style={{display:"none"}}>更新</div>
            </div>
        )
    }
}
